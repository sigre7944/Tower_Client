...
export const completed_day_tasks = (state = Map(), action) => {
  switch (action.type) {
    ...
    case "RESET_COMPLETED_DAY_TASKS":
      return Map();
...
export const completed_week_tasks = (state = Map(), action) => {
  switch (action.type) {
    ...
    case "RESET_COMPLETED_WEEK_TASKS":
      return Map();
...
export const completed_month_tasks = (state = Map(), action) => {
  switch (action.type) {
    ...
    case "RESET_COMPLETED_MONTH_TASKS":
      return Map();
...
function getNoWeekInMonth(date) {
  ...
  let first_monday_of_month_timestamp = getMonday(
