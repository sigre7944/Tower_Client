...
export default class EditMultipleTasks extends React.PureComponent {
    ...
    _checkTaskToEdit = (task_id) => {
        if (this.checked_task_data.hasIn([task_id, "checked"])) {
            ...
            this.checked_task_data.update(task_id, (value) => fromJS({
                task_id,
                checked: true
            }))
            Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)
    ...
    render() {
        ...
        if (this.props.currentChosenJournalType === "day") {
            ...
            date_text = `${this.month_names[chosen_date_data.get("month")]} ${chosen_date_data.get("year")}`
...
class TaskCardsFlatlist extends React.PureComponent {
    ...
    _keyExtractor = (item, index) => `journal-edit-multiple-${this.props.type}-task-${item[0]}`
        ...
        return (
            <View>
                {this.update_obj.should_render ?
                    ...
                    <View
                        style={styles.task_card_container}
                    >
                        <View
                            style={{
                                flexDirection: "row",
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {this.update_obj.title}
                                </Text>

                                <Text
                                    style={styles.goal_tracking}
                                >
                                    {this.update_obj.current_goal_value} / {this.update_obj.goal_value}
                                </Text>
                            </TouchableOpacity>
                        </View>
...
class CheckBox extends React.PureComponent {
    ...
    render() {
        ...
        return (
            <View
                style={complete_box_container_style}
            >
