...
export default class ChangePlanToFree extends React.PureComponent {
  render() {
    return (
          ...
          >
            ...
            >
              <Text style={styles.normal_text}>
                Uh oh! - Your Premium plan has expired!
              </Text>
            </View>
            ...
            >
              <Text style={styles.normal_text}>
                Don't worry, your data is reserverd and will be available as
                soon as you upgrade!
              </Text>
            </View>
