    ...
    setWeeklyRepeatPickerValue = (value) => {
        ...
        if (this.repetion_data.type && this.repetion_data.type === "weekly-w") {
            let data = {
                ...
                interval: {
                    value: this.repetion_data.interval.value
...
class DayRepeatEveryHolder extends React.PureComponent {
    ...
    chooseDaily = () => {
        ...
        let { repeat } = this.props.task_data
...
class DayWeeklyRepeatOption extends React.PureComponent {
    ...
    daysInWeek = this.props.task_data.repeat && this.props.task_data.repeat.interval && this.props.task_data.repeat.interval.daysInWeek ? this.props.task_data.repeat.interval.daysInWeek : []
...
class WeeklyOption extends React.PureComponent {
    ...
    componentDidMount() {
        if (this.props.task_data.repeat && this.props.task_data.repeat.interval && this.props.task_data.repeat.interval.daysInWeek) {
            if (this.props.task_data.repeat.interval.daysInWeek.includes(this.props.index)) {
                this._onPress()
            }
        }
...
export class EndRepeatHolder extends React.PureComponent {
    ...
    componentDidMount() {
        let end = this.props.task_data.end
