...
class Calendar extends React.Component {
    ...
    _keyExtractor = (item, index) => `progress-chart-month-type-calendar-year-${index}`
    ...
    initYearData = () => {
        ...
        this.start_index = this.findStartIndex(this.props.chosen_month, this.props.chosen_year)
    }
