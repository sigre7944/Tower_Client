...
export default class TaskDetailModal extends React.PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      this.state.is_delete_selected !== prevState.is_delete_selected &&
      this.yes_delete_clicked
    ) {
      this.props.closeModal();
    }
            ...
            {this.state.is_edit_selected ? (
              ...
              <>
                ...
                <ScrollView>
                  ...
                  <ScheduleRow schedule_text={task_schedule_text} />
                  ...
                  <RepeatRow repeat_text={task_repeat_text} />

                  <EndRow end_text={task_end_text} />

                  <RewardRow reward_text={task_reward_text} />

                  <GoalRow goal_text={task_goal_text} />
                </ScrollView>
              </>
            )}
          </Animated.View>
