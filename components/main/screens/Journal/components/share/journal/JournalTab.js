...
export default class JournalTab extends React.PureComponent {
  ...
  render() {
    return (
      ...
      >
        {this.props.type === "day" ? (
          <DayFlatlist setChosenDateData={this.setChosenDateData} />
        ) : (
          <>
            {this.props.type === "week" ? (
              <WeekFlatlist setChosenDateData={this.setChosenDateData} />
            ) : (
              <MonthFlatlist setChosenDateData={this.setChosenDateData} />
            )}
          </>
        )}
...
class UncompletedTaskCardHolder extends React.PureComponent {
  ...
  _keyExtractor = (item, index) =>
    `journal-${this.props.type}-uncompleted-task-${item[0]}`;
  ...
  checkIfChosenDateIsToday = (chosen_date_data, type) => {
    ...
    if (type === "day") {
      ...
      if (
        ...
        start_year === current.getFullYear()
      ) {
        is_chosen_date_today = true;
      } else {
        is_chosen_date_today = false;
...
class CompletedTaskCardHolder extends React.PureComponent {
  ...
  _keyExtractor = (item, index) =>
    `journal-${this.props.type}-completed-task-${item[0]}`;
    ...
    if (task_id && task_id === completed_task.get("id")) {
      ...
      if (current_chosen_category === category) {
        if (type === "day") {
          ...
          if (
            hasIn(completed_task, [
              chosen_day_timestamp_to_string,
              "current"
            ]) &&
            parseInt(
              getIn(
          ...
          if (
            hasIn(completed_task, [
              chosen_week_timestamp_to_string,
              "current"
            ]) &&
            parseInt(
              getIn(
          ...
          if (
            hasIn(completed_task, [
              chosen_month_timestamp_to_string,
              "current"
            ]) &&
            parseInt(
              getIn(
