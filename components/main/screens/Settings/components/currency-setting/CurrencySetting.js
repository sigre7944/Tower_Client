...
export default class CurrencySetting extends React.PureComponent {
  ...
  render() {
    let currency_selection = Map(this.props.generalSettings).getIn([
        "currency"
      ]),
    ...
    return (
      <>
        ...
        >
          <Text style={styles.normal_text}>Currency</Text>

          <Text style={styles.currency_symbol}>{currency_symbol}</Text>
        </TouchableOpacity>
