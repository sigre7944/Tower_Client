...
export const deleteTasksAndHistory = ({
    ...
    dispatch(batchActions([
        ...
        returnNewStats("RETURN_NEW_DAY_STATS", new_day_stats),
        returnNewStats("RETURN_NEW_WEEK_STATS", new_week_stats),
        returnNewStats("RETURN_NEW_MONTH_STATS", new_month_stats),
